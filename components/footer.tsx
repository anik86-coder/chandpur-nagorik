    ...
    মতামত
        ...
        <div className="border-t border-gray-100 pt-6 flex flex-col justify-center items-center gap-4">
          ...
          <div className="flex gap-5 items-center justify-center">
            ...
            {/* Twitter/X */}
            <a href="https://x.com/chanpdurnagorik" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-black transition-colors" aria-label="Twitter">
