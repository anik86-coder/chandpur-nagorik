...
export const metadata = {
  title: "হাসপাতাল | চাঁদপুর নাগরিক",
  description: "চাঁদপুরের হাসপাতালের নাম, ফোন নম্বর ও ঠিকানা।",
};
  ...
  return (
    <main className="min-h-[calc(100vh-75px)] sm:min-h-[calc(100vh-85px)] bg-gray-50 font-[Kalpurush]">
      <div className="max-w-screen-xl mx-auto px-4 py-6 md:py-10">
        ...
        {/* Header */}
        <section className="bg-[#116cb4] rounded-2xl p-6 md:p-8 text-white text-center shadow-md">
        ...
        {/* Hospital List */}
        <section className="mt-6 md:mt-8 space-y-3">
            ...
            >
              <div className="bg-white border border-gray-200 rounded-xl px-4 py-4 md:px-5 md:py-5 shadow-sm hover:-translate-y-0.5 hover:shadow-md hover:border-blue-200 transition-all duration-200">
                ...
                <div className="flex items-start gap-3 md:gap-4">
                  ...
                  {/* Serial */}
                  <div className="shrink-0 w-9 h-9 md:w-10 md:h-10 rounded-lg bg-blue-50 text-[#116cb4] flex items-center justify-center font-bold text-base md:text-lg group-hover:bg-[#116cb4] group-hover:text-white transition-colors">
                    {index + 1}
                  </div>
